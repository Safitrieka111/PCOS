      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <a href="#" class="list-group-item active">
                    ...
                    <p class="list-group-item-text">Sistem pakar  Diagnosa Gejala Penyakit Polycystic Ovarian Syndrome (PCOS) adalah sebuah sistem  pakar untuk mendiagnosa pasien. Proses diagnosa dengan menentukan gejala-gejala yang terjadi pada  wanita, dengan menggunakan perhitungan metode <em>Case Based Reasoning</em> maka sistem dapat memberikan keputusan tentang hasil diagnosa.</p>
                  </a>
