        ...
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="sub open">
            ...
            <ul class="templatemo-submenu">
              ...
              <li><a class="bg-primary" href="gejala.php"><span class="badge pull-right"><?php $queryNP=mysqli_query($con,"SELECT * FROM gejala"); $numNP=mysqli_num_rows($queryNP); echo $numNP;?></span>Data Gejala</a></li>   
  ...
  <button type="submit" class="btn btn-default">Simpan</button>
   ...
   ?>
                    <tr>
                      ...
                      <td><a href="edgejala.php?id=<?php echo $data->kd_gejala;?>" class="btn btn-default">Edit</a></td>                    
                      <td><a onClick="return HapusData('<?php echo $data->kd_gejala;?>');" data-toggle="modal" data-target="#confirmModal2" class="btn btn-link">Delete</a>
                      </td>
                    </tr><?php }?>                    
                  </tbody>
                </table>
