...
<div class="container text-justify">    
  ...
  <table class="table table-striped table-hover table-bordered">
	...
	$resultP = $con->query(" SELECT * FROM pasien,analisa_hasil WHERE analisa_hasil.idpasien='$iduser' group by analisa_hasil.idpasien  ORDER BY analisa_hasil.idhasil DESC ") ;
	$no=0;
